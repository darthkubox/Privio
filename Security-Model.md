...
| **Automatyczne wznawianie** | Osobny LaunchAgent nadzoruje zainstalowane Privio i uruchamia je ponownie po nagłym zakończeniu. Nowa sesja przywraca blokady, a normalne wyjście i aktualizacja pozostają możliwe | Pozostawieniem ochrony wyłączonej po zamknięciu samego procesu Privio | Wymaga zgody macOS na działanie w tle. Podczas restartu występuje przerwa w ochronie. Zatrzymanie również agenta lub zmiana lokalnych plików przez właściciela konta może obejść wznawianie. Nie zastępuje niezależnego procesu egzekwującego blokady |
